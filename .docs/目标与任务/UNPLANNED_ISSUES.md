...
> 已消化/已修复项（U-05、U-08、U-09、U-10）已随各周期落地，2026-09-17 清理移出本档；**U-12（follow 域大集全量装载）已随第六期 T7 落地**（转 NEEDS N11 → T7；残留装载形态转 **U-18**）。U-13（评论树全量）已转第六期 NEEDS **N11b**（=T8），落地后移出。
