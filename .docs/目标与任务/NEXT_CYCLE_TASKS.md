...
> 状态：**杂务/准备周期（分支 `prep/next-phase`）**——不做正式功能方向，处理代码卫生与铺垫清理。方向（R-03）已于 2026-09-18 拍板拆任务：T1~T6 第一批（基座/卫生，优先执行）+ T7~T9 第二批（用户点名主菜）。**进度：T1~T6 已全部完成；T7 执行中（2026-09-19 起，A1+B2 已拍板，见 NEEDS 4.0 决策段）。**
